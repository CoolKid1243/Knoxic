...
namespace knoxic {
    ...
    const PipelineConfigInfo &configInfo) {
        ...
        if (vkCreateGraphicsPipelines(knoxicDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo,
    ...
    PipelineConfigInfo KnoxicPipeline::defaultPipelineConfigInfo(uint32_t width, uint32_t height) {
